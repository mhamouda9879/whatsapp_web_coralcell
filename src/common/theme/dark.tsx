...
export const darkTheme: DefaultTheme = {
  ...
  common: {
    ...
    liveAgentBackgroundColor: "#1a3c4b", // Dark blue-green
    robotBackgroundColor: "#242f36", // Dark gray
    liveAgentBorderColor: "#0da9e5", // Bright blue
    robotBorderColor: "#3C4247", // Neutral gray
  },
  alert: {
    infoColor: "#085373",
